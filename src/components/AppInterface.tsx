...
import { Cpu, Globe, Gift, Users, User, Sparkles, Send, Download, RefreshCw, ArrowRightLeft, BarChart2, ChevronRight } from 'lucide-react';
      ...
      >
          ...
          <div className="mining-progress-container" style={{
            ...
            <button 
              ...
              style={{
                ...
                top: '15px',
                right: '15px',
                background: miningProgress >= 100 ? themeColors.primary : '#2A3441',
                color: miningProgress >= 100 ? '#FFFFFF' : '#6B7280',
                padding: '6px 16px',
                borderRadius: '6px',
                border: miningProgress >= 100 ? `1px solid ${themeColors.secondary}` : '1px solid rgba(120, 132, 156, 0.1)',
                fontSize: '12px',
                fontWeight: '500',
                textTransform: 'uppercase',
                letterSpacing: '0.5px',
        ...
        {miningActive && (
          <div style={{
            ...
            <button
              onClick={() => {
                console.log('Test button clicked - completing mining instantly');
                setCountdownSeconds(0);
                setMiningProgress(100);
                // Stop mining and enable claim
                setMiningActive(false);
                setCanClaim(true);
              }}
              style={{
              ...
              onMouseLeave={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 2px 8px rgba(255, 165, 0, 0.2)';
              }}
              title="Testing: Instantly complete mining to 100%"
            >
      ...
      <AnimatePresence>
        ...
        >
          ...
          <div className="nav-content">
            <PremiumNavButton icon={Globe} label="Global" onClick={handleEmptyClick} />
